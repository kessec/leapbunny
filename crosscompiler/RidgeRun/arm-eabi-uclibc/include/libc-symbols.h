...
#  define weak_tls_alias(name, aliasname) \
      _weak_alias (__thread, name, aliasname)
#  define _weak_alias(thread, name, aliasname)				\
 extern thread __typeof (name) aliasname __attribute__ ((weak, alias (#name)));
...
#  define hidden_strong_alias(name, aliasname) \
  strong_alias (name, aliasname __attribute__ ((visibility ("hidden"))))
#  define hidden_weak_alias(name, aliasname) \
  weak_alias (name, aliasname __attribute__ ((visibility ("hidden"))))
