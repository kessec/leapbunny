...
#define __KERNEL_SOURCE__ "/tmp/toolchain_src/arm-eabi-uclibc-buildroot/buildroot/toolchain_build_arm_nofpu/linux"
 ...
 */
#define __CROSS_COMPILER_PREFIX__ "/opt/RidgeRun/arm-eabi-uclibc/bin/arm-linux-uclibcgnueabi-"
#undef __DODEBUG__
#undef __DOSTRIP__
#undef __DOASSERTS__
