/* usbDescriptors-madrid.c -- USB descriptor structures
 *
...
const u16 USB_STR_2[17] = {0x300 + sizeof(USB_STR_2),
					      'L','e','a','p','P','a','d',' ',
						  'E','x','p','l','o','r','e','r'};
...
const u8 sc_FullSpeedDeviceDescriptor[SIZEOF_DEV_DESCRIPTOR] =
{
	...
	PRODUCTID_MADRID%0x100,				// 10 product ID LSB
	PRODUCTID_MADRID/0x100,				// 11 product ID MSB
