...
#define _u16_ACCESS	0
/* The _u16_ACCESS option defines which access method is used to the word
...
/  word access results incorrect behavior, the _u16_ACCESS must be set to 0.
...
#if _u16_ACCESS == 1	/* Enable word access to the FAT structure */
