cmd_arch/arm/mach-lf1000/pwm.o := arm-linux-gcc -Wp,-MD,arch/arm/mach-lf1000/.pwm.o.d  -nostdinc -isystem /opt/RidgeRun/arm-eabi-uclibc/lib/gcc/arm-linux-uclibcgnueabi/4.1.1/include -Iinclude  -I/vol/hdd0/Git/leapbunny/LF1000/linux-2.6/arch/arm/include -include include/linux/autoconf.h -D__KERNEL__ -mlittle-endian -Iarch/arm/mach-lf1000/include -Iarch/arm/plat-mes/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -O3 -marm -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=5 -mcpu=arm926ej-s -msoft-float -Uarm -fno-stack-protector -fomit-frame-pointer -g -Wdeclaration-after-statement -Wno-pointer-sign   -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(pwm)"  -D"KBUILD_MODNAME=KBUILD_STR(pwm)"  -c -o arch/arm/mach-lf1000/pwm.o arch/arm/mach-lf1000/pwm.c

deps_arch/arm/mach-lf1000/pwm.o := \
  arch/arm/mach-lf1000/pwm.c \
  ...
  arch/arm/mach-lf1000/include/mach/pwm.h \
  ...
  include/linux/uio.h \
  arch/arm/mach-lf1000/include/mach/pwm_hal.h \

arch/arm/mach-lf1000/pwm.o: $(deps_arch/arm/mach-lf1000/pwm.o)
